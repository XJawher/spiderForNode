 ...
 * 优化数据结构, 全局的数据可以忽略
 */
new cron.CronJob('01 01 17 * * 5', async () => {
    city.lianjia();
}, null, true);
 ...
 *
 */
new cron.CronJob('01 05 17 * * 5', async () => {
 ...
 * 更新了全局的数据结构
 */
new cron.CronJob('01 10 17 * * 5', async () => {
    restructureCity.hf();
}, null, true);
 ...
 */
new cron.CronJob('01 15 17 * * 5', async () => {
    restructureCity.bj();
}, null, true);
 ...
 */
new cron.CronJob('01 20 17 * * 5', async () => {
    restructureCity.cq();
}, null, true);
 ...
 */
new cron.CronJob('01 25 17 * * 5', async () => {
    restructureCity.fz();
}, null, true);
 ...
 */
new cron.CronJob('01 30 179 * * 5', async () => {
    restructureCity.gz();
}, null, true);
 ...
 */
new cron.CronJob('01 35 17 * * 5', async () => {
    restructureCity.ty();
}, null, true);
 ...
 */
new cron.CronJob('01 40 17 * * 5', async () => {
    restructureCity.tj();
}, null, true);
 ...
 */
new cron.CronJob('01 45 17 * * 5', async () => {
    restructureCity.km();
}, null, true);
 ...
 */
new cron.CronJob('01 50 17 * * 5', async () => {
    restructureCity.hz();
}, null, true);
 ...
 */
new cron.CronJob('01 55 17 * * 5', async () => {
 ...
 */
new cron.CronJob('01 01 18 * * 5', async () => {
    restructureCity.cd();
}, null, true);
 ...
 */
new cron.CronJob('01 55 18 * * 5', async () => {
    restructureCity.gy();
}, null, true);
 ...
 */
new cron.CronJob('01 50 18 * * 5', async () => {
    restructureCity.nn();
}, null, true);
 ...
 */
new cron.CronJob('01 45 18 * * 5', async () => {
    restructureCity.lz();
}, null, true);
 ...
 */
new cron.CronJob('01 40 18 * * 5', async () => {
    restructureCity.wh();
}, null, true);
 ...
 */
new cron.CronJob('01 35 18 * * 5', async () => {
    restructureCity.cs();
}, null, true);
 ...
 */
new cron.CronJob('01 30 18 * * 5', async () => {
    restructureCity.jn();
}, null, true);
 ...
 */
new cron.CronJob('01 25 18 * * 5', async () => {
    restructureCity.sjz();
}, null, true);
 ...
 */
new cron.CronJob('01 20 18 * * 5', async () => {
    restructureCity.hk();
}, null, true);
 ...
 */
new cron.CronJob('01 15 18 * * 5', async () => {
    restructureCity.zz();
}, null, true);
 ...
 */
new cron.CronJob('01 10 18 * * 5', async () => {
    restructureCity.hrb();
}, null, true);
 ...
 */
new cron.CronJob('01 05 18 * * 5', async () => {
    restructureCity.cc();
}, null, true);
 ...
 */
new cron.CronJob('01 00 19 * * 5', async () => {
    restructureCity.nj();
}, null, true);
 ...
 */
new cron.CronJob('01 05 19 * * 5', async () => {
    restructureCity.nc();
}, null, true);
 ...
 */
new cron.CronJob('01 10 19 * * 5', async () => {
    restructureCity.sy();
}, null, true);
 ...
 */
new cron.CronJob('01 15 19 * * 5', async () => {
 ...
 */
new cron.CronJob('01 20 19 * * 5', async () => {
 ...
 */
new cron.CronJob('01 25 19 * * 5', async () => {
    restructureCity.sh();
}, null, true);
