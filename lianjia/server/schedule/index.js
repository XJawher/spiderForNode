 ...
 * 优化数据结构, 全局的数据可以忽略
 */
new cron.CronJob('01 01 17 * * 2', async () => {
    city.lianjia();
}, null, true);
 ...
 *
 */
new cron.CronJob('01 05 17 * * 2', async () => {
 ...
 * 更新了全局的数据结构
 */
new cron.CronJob('01 10 17 * * 2', async () => {
    restructureCity.hf();
}, null, true);
 ...
 */
new cron.CronJob('01 15 17 * * 2', async () => {
    restructureCity.bj();
}, null, true);
 ...
 */
new cron.CronJob('01 20 17 * * 2', async () => {
    restructureCity.cq();
}, null, true);
 ...
 */
new cron.CronJob('01 25 17 * * 2', async () => {
    restructureCity.fz();
}, null, true);
 ...
 */
new cron.CronJob('01 30 179 * * 2', async () => {
    restructureCity.gz();
}, null, true);
 ...
 */
new cron.CronJob('01 35 17 * * 2', async () => {
    restructureCity.ty();
}, null, true);
 ...
 */
new cron.CronJob('01 40 17 * * 2', async () => {
    restructureCity.tj();
}, null, true);
 ...
 */
new cron.CronJob('01 45 17 * * 2', async () => {
    restructureCity.km();
}, null, true);
 ...
 */
new cron.CronJob('01 50 17 * * 2', async () => {
    restructureCity.hz();
}, null, true);
 ...
 */
new cron.CronJob('01 55 17 * * 2', async () => {
 ...
 */
new cron.CronJob('01 01 18 * * 2', async () => {
    restructureCity.cd();
}, null, true);
 ...
 */
new cron.CronJob('01 55 18 * * 2', async () => {
    restructureCity.gy();
}, null, true);
 ...
 */
new cron.CronJob('01 50 18 * * 2', async () => {
    restructureCity.nn();
}, null, true);
 ...
 */
new cron.CronJob('01 45 18 * * 2', async () => {
    restructureCity.lz();
}, null, true);
 ...
 */
new cron.CronJob('01 40 18 * * 2', async () => {
    restructureCity.wh();
}, null, true);
 ...
 */
new cron.CronJob('01 35 18 * * 2', async () => {
    restructureCity.cs();
}, null, true);
 ...
 */
new cron.CronJob('01 30 18 * * 2', async () => {
    restructureCity.jn();
}, null, true);
 ...
 */
new cron.CronJob('01 25 18 * * 2', async () => {
    restructureCity.sjz();
}, null, true);
 ...
 */
new cron.CronJob('01 20 18 * * 2', async () => {
    restructureCity.hk();
}, null, true);
 ...
 */
new cron.CronJob('01 15 18 * * 2', async () => {
    restructureCity.zz();
}, null, true);
 ...
 */
new cron.CronJob('01 10 18 * * 2', async () => {
    restructureCity.hrb();
}, null, true);
 ...
 */
new cron.CronJob('01 05 18 * * 2', async () => {
    restructureCity.cc();
}, null, true);
 ...
 */
new cron.CronJob('01 00 19 * * 2', async () => {
    restructureCity.nj();
}, null, true);
 ...
 */
new cron.CronJob('01 05 19 * * 2', async () => {
    restructureCity.nc();
}, null, true);
 ...
 */
new cron.CronJob('01 10 19 * * 2', async () => {
    restructureCity.sy();
}, null, true);
 ...
 */
new cron.CronJob('01 15 19 * * 2', async () => {
 ...
 */
new cron.CronJob('01 20 19 * * 2', async () => {
 ...
 */
new cron.CronJob('01 25 19 * * 2', async () => {
    restructureCity.sh();
}, null, true);
