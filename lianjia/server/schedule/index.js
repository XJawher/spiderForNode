 ...
 * 优化数据结构, 全局的数据可以忽略
 */
new cron.CronJob('01 23 17 * * 0', async () => {
    city.lianjia();
}, null, true);
 ...
 *
 */
new cron.CronJob('01 50 17 * * 0', async () => {
 ...
 * 更新了全局的数据结构
 */
new cron.CronJob('01 29 17 * * 0', async () => {
    restructureCity.hf();
}, null, true);
 ...
 */
new cron.CronJob('01 33 17 * * 0', async () => {
    restructureCity.bj();
}, null, true);
 ...
 */
new cron.CronJob('01 36 17 * * 0', async () => {
    restructureCity.cq();
}, null, true);
 ...
 */
new cron.CronJob('01 39 17 * * 0', async () => {
    restructureCity.fz();
}, null, true);
 ...
 */
new cron.CronJob('01 43 17 * * 0', async () => {
    restructureCity.gz();
}, null, true);
 ...
 */
new cron.CronJob('01 46 17 * * 0', async () => {
    restructureCity.ty();
}, null, true);
 ...
 */
new cron.CronJob('01 49 17 * * 0', async () => {
    restructureCity.tj();
}, null, true);
 ...
 */
new cron.CronJob('01 53 17 * * 0', async () => {
    restructureCity.km();
}, null, true);
 ...
 */
new cron.CronJob('01 56 17 * * 0', async () => {
    restructureCity.hz();
}, null, true);
 ...
 */
new cron.CronJob('01 17 17 * * 0', async () => {
 ...
 */
new cron.CronJob('01 03 17 * * 0', async () => {
    restructureCity.cd();
}, null, true);
 ...
 */
new cron.CronJob('01 06 17 * * 0', async () => {
    restructureCity.gy();
}, null, true);
 ...
 */
new cron.CronJob('01 09 17 * * 0', async () => {
    restructureCity.nn();
}, null, true);
 ...
 */
new cron.CronJob('01 13 17 * * 0', async () => {
    restructureCity.lz();
}, null, true);
 ...
 */
new cron.CronJob('01 19 17 * * 0', async () => {
    restructureCity.cs();
}, null, true);
 ...
 */
new cron.CronJob('01 00 17 * * 0', async () => {
    restructureCity.jn();
}, null, true);
 ...
 */
new cron.CronJob('01 05 17 * * 0', async () => {
    restructureCity.sjz();
}, null, true);
 ...
 */
new cron.CronJob('01 10 17 * * 0', async () => {
    restructureCity.hk();
}, null, true);
 ...
 */
new cron.CronJob('01 15 17 * * 0', async () => {
    restructureCity.zz();
}, null, true);
 ...
 */
new cron.CronJob('01 20 17 * * 0', async () => {
    restructureCity.hrb();
}, null, true);
 ...
 */
new cron.CronJob('01 25 17 * * 0', async () => {
    restructureCity.cc();
}, null, true);
 ...
 */
new cron.CronJob('01 35 17 * * 0', async () => {
    restructureCity.nj();
}, null, true);
 ...
 */
new cron.CronJob('01 30 17 * * 0', async () => {
    restructureCity.nc();
}, null, true);
 ...
 */
new cron.CronJob('01 40 17 * * 0', async () => {
    restructureCity.sy();
}, null, true);
 ...
 */
new cron.CronJob('01 45 17 * * 0', async () => {
 ...
 */
new cron.CronJob('01 44 17 * * 0', async () => {
    restructureCity.sh();
}, null, true);
