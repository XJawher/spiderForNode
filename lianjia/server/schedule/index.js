 ...
 * 优化数据结构, 全局的数据可以忽略
 */
new cron.CronJob('01 01 01 * * 3', async () => {
    city.lianjia();
}, null, true);
 ...
 *
 */
new cron.CronJob('01 05 01 * * 3', async () => {
 ...
 * 更新了全局的数据结构
 */
new cron.CronJob('01 10 01 * * 3', async () => {
    restructureCity.hf();
}, null, true);
 ...
 */
new cron.CronJob('01 15 01 * * 3', async () => {
    restructureCity.bj();
}, null, true);
 ...
 */
new cron.CronJob('01 20 01 * * 3', async () => {
    restructureCity.cq();
}, null, true);
 ...
 */
new cron.CronJob('01 25 01 * * 3', async () => {
    restructureCity.fz();
}, null, true);
 ...
 */
new cron.CronJob('01 30 179 * * 3', async () => {
    restructureCity.gz();
}, null, true);
 ...
 */
new cron.CronJob('01 35 01 * * 3', async () => {
    restructureCity.ty();
}, null, true);
 ...
 */
new cron.CronJob('01 40 01 * * 3', async () => {
    restructureCity.tj();
}, null, true);
 ...
 */
new cron.CronJob('01 45 01 * * 3', async () => {
    restructureCity.km();
}, null, true);
 ...
 */
new cron.CronJob('01 50 01 * * 3', async () => {
    restructureCity.hz();
}, null, true);
 ...
 */
new cron.CronJob('01 55 01 * * 3', async () => {
 ...
 */
new cron.CronJob('01 30 01 * * 3', async () => {
    restructureCity.jn();
}, null, true);
 ...
 */
new cron.CronJob('01 00 01 * * 3', async () => {
    restructureCity.nj();
}, null, true);
