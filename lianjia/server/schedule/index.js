 ...
 */
new cron.CronJob('01 23 18 * * *', async () => {
    city.lianjia();
}, null, true);
 ...
 */
new cron.CronJob('01 50 18 * * *', async () => {
    xian.lianjia();
}, null, true);
 ...
 */
new cron.CronJob('01 29 18 * * *', async () => {
    city.hf();
}, null, true);
 ...
 */
new cron.CronJob('01 33 18 * * *', async () => {
    city.bj();
}, null, true);
 ...
 */
new cron.CronJob('01 36 18 * * *', async () => {
    city.cq();
}, null, true);
 ...
 */
new cron.CronJob('01 39 18 * * *', async () => {
    city.fz();
}, null, true);
 ...
 */
new cron.CronJob('01 43 18 * * *', async () => {
    city.gz();
}, null, true);
 ...
 */
new cron.CronJob('01 46 18 * * *', async () => {
    city.ty();
}, null, true);
 ...
 */
new cron.CronJob('01 49 18 * * *', async () => {
    city.tj();
}, null, true);
 ...
 */
new cron.CronJob('01 53 18 * * *', async () => {
    city.km();
}, null, true);
 ...
 */
new cron.CronJob('01 56 18 * * *', async () => {
    city.hz();
}, null, true);
 ...
 */
new cron.CronJob('01 59 18 * * *', async () => {
    shenzhen.lianjia();
}, null, true);
 ...
 */
new cron.CronJob('01 00 18 * * *', async () => {
    city.jn();
}, null, true);
 ...
 */
new cron.CronJob('01 05 18 * * *', async () => {
    city.sjz();
}, null, true);
 ...
 */
new cron.CronJob('01 10 18 * * *', async () => {
    city.hk();
}, null, true);
 ...
 */
new cron.CronJob('01 15 18 * * *', async () => {
    city.zz();
}, null, true);
 ...
 */
new cron.CronJob('01 20 18 * * *', async () => {
    city.hrb();
}, null, true);
 ...
 */
new cron.CronJob('01 25 18 * * *', async () => {
    city.cc();
}, null, true);
 ...
 */
new cron.CronJob('01 35 18 * * *', async () => {
    city.nj();
}, null, true);
 ...
 */
new cron.CronJob('01 30 18 * * *', async () => {
    city.nc();
}, null, true);
 ...
 */
new cron.CronJob('01 40 18 * * *', async () => {
    city.sy();
}, null, true);
 ...
 */
new cron.CronJob('01 45 18 * * *', async () => {
    city.hhht();
}, null, true);
 ...
 */
new cron.CronJob('01 44 17 * * *', async () => {
    shanghai.lianjia();
}, null, true);
