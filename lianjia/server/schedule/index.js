 ...
 * 优化数据结构, 全局的数据可以忽略
 */
new cron.CronJob('01 23 15 * * 4', async () => {
    city.lianjia();
}, null, true);
 ...
 *
 */
new cron.CronJob('01 50 15 * * 4', async () => {
 ...
 * 更新了全局的数据结构
 */
new cron.CronJob('01 29 15 * * 4', async () => {
    restructureCity.hf();
}, null, true);
 ...
 */
new cron.CronJob('01 33 15 * * 4', async () => {
    restructureCity.bj();
}, null, true);
 ...
 */
new cron.CronJob('01 36 15 * * 4', async () => {
    restructureCity.cq();
}, null, true);
 ...
 */
new cron.CronJob('01 39 15 * * 4', async () => {
    restructureCity.fz();
}, null, true);
 ...
 */
new cron.CronJob('01 43 15 * * 4', async () => {
    restructureCity.gz();
}, null, true);
 ...
 */
new cron.CronJob('01 46 15 * * 4', async () => {
    restructureCity.ty();
}, null, true);
 ...
 */
new cron.CronJob('01 49 15 * * 4', async () => {
    restructureCity.tj();
}, null, true);
 ...
 */
new cron.CronJob('01 53 15 * * 4', async () => {
    restructureCity.km();
}, null, true);
 ...
 */
new cron.CronJob('01 56 15 * * 4', async () => {
    restructureCity.hz();
}, null, true);
 ...
 */
new cron.CronJob('01 03 15 * * 4', async () => {
    restructureCity.cd();
}, null, true);
 ...
 */
new cron.CronJob('01 06 15 * * 4', async () => {
    restructureCity.gy();
}, null, true);
 ...
 */
new cron.CronJob('01 09 15 * * 4', async () => {
    restructureCity.nn();
}, null, true);
 ...
 */
new cron.CronJob('01 13 15 * * 4', async () => {
    restructureCity.lz();
}, null, true);
 ...
 */
new cron.CronJob('01 19 15 * * 4', async () => {
    restructureCity.cs();
}, null, true);
 ...
 */
new cron.CronJob('01 00 15 * * 4', async () => {
    restructureCity.jn();
}, null, true);
 ...
 */
new cron.CronJob('01 05 15 * * 4', async () => {
    restructureCity.sjz();
}, null, true);
 ...
 */
new cron.CronJob('01 10 15 * * 4', async () => {
    restructureCity.hk();
}, null, true);
 ...
 */
new cron.CronJob('01 15 15 * * 4', async () => {
    restructureCity.zz();
}, null, true);
 ...
 */
new cron.CronJob('01 20 15 * * 4', async () => {
    restructureCity.hrb();
}, null, true);
 ...
 */
new cron.CronJob('01 25 15 * * 4', async () => {
    restructureCity.cc();
}, null, true);
 ...
 */
new cron.CronJob('01 35 15 * * 4', async () => {
    restructureCity.nj();
}, null, true);
 ...
 */
new cron.CronJob('01 30 15 * * 4', async () => {
    restructureCity.nc();
}, null, true);
 ...
 */
new cron.CronJob('01 40 15 * * 4', async () => {
    restructureCity.sy();
}, null, true);
 ...
 */
new cron.CronJob('01 45 15 * * 4', async () => {
 ...
 */
new cron.CronJob('01 44 15 * * 4', async () => {
    restructureCity.sh();
}, null, true);
