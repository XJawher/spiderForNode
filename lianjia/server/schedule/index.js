 ...
 * 优化数据结构, 全局的数据可以忽略
 */
new cron.CronJob('01 01 17 * * 4', async () => {
    city.lianjia();
}, null, true);
 ...
 *
 */
new cron.CronJob('01 05 17 * * 4', async () => {
 ...
 * 更新了全局的数据结构
 */
new cron.CronJob('01 10 17 * * 4', async () => {
    restructureCity.hf();
}, null, true);
 ...
 */
new cron.CronJob('01 15 17 * * 4', async () => {
    restructureCity.bj();
}, null, true);
 ...
 */
new cron.CronJob('01 20 17 * * 4', async () => {
    restructureCity.cq();
}, null, true);
 ...
 */
new cron.CronJob('01 25 17 * * 4', async () => {
    restructureCity.fz();
}, null, true);
 ...
 */
new cron.CronJob('01 30 179 * * 4', async () => {
    restructureCity.gz();
}, null, true);
 ...
 */
new cron.CronJob('01 35 17 * * 4', async () => {
    restructureCity.ty();
}, null, true);
 ...
 */
new cron.CronJob('01 40 17 * * 4', async () => {
    restructureCity.tj();
}, null, true);
 ...
 */
new cron.CronJob('01 45 17 * * 4', async () => {
    restructureCity.km();
}, null, true);
 ...
 */
new cron.CronJob('01 50 17 * * 4', async () => {
    restructureCity.hz();
}, null, true);
 ...
 */
new cron.CronJob('01 55 17 * * 4', async () => {
 ...
 */
new cron.CronJob('01 30 17 * * 4', async () => {
    restructureCity.jn();
}, null, true);
 ...
 */
new cron.CronJob('01 00 17 * * 4', async () => {
    restructureCity.nj();
}, null, true);
