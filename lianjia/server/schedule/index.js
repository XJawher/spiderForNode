 ...
 * 优化数据结构, 全局的数据可以忽略
 */
new cron.CronJob('01 01 14 * * 4', async () => {
    city.lianjia();
}, null, true);
 ...
 *
 */
new cron.CronJob('01 05 14 * * 4', async () => {
 ...
 * 更新了全局的数据结构
 */
new cron.CronJob('01 10 14 * * 4', async () => {
    restructureCity.hf();
}, null, true);
 ...
 */
new cron.CronJob('01 15 14 * * 4', async () => {
    restructureCity.bj();
}, null, true);
 ...
 */
new cron.CronJob('01 20 14 * * 4', async () => {
    restructureCity.cq();
}, null, true);
 ...
 */
new cron.CronJob('01 25 14 * * 4', async () => {
    restructureCity.fz();
}, null, true);
 ...
 */
new cron.CronJob('01 35 14 * * 4', async () => {
    restructureCity.ty();
}, null, true);
 ...
 */
new cron.CronJob('01 40 14 * * 4', async () => {
    restructureCity.tj();
}, null, true);
 ...
 */
new cron.CronJob('01 45 14 * * 4', async () => {
    restructureCity.km();
}, null, true);
 ...
 */
new cron.CronJob('01 50 14 * * 4', async () => {
    restructureCity.hz();
}, null, true);
 ...
 */
new cron.CronJob('01 55 14 * * 4', async () => {
 ...
 */
new cron.CronJob('01 30 14 * * 4', async () => {
    restructureCity.jn();
}, null, true);
 ...
 */
new cron.CronJob('01 00 14 * * 4', async () => {
    restructureCity.nj();
}, null, true);
