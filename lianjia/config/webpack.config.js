...
// Implements the node require.resolve() algorithm such that you can require.resolve() on
// behalf of a file asynchronously and synchronously
const resolve = require('resolve');
// Adds support for installing with Plug'n'Play in webpack by yarn.
...
// An alternative of uglify-js which doesn't support the new syntax brought by ES6 and
// is no longer maintained.
const TerserPlugin = require('terser-webpack-plugin');
// This plugin extracts CSS into separate files. It creates a CSS file per JS file which
// contains CSS. It supports On-Demand-Loading of CSS and SourceMaps. For lower version of
// webpack, we can use "extract-text-webpack-plugin" instead.
const MiniCssExtractPlugin = require('mini-css-extract-plugin');
// A Webpack plugin to optimize\minimize CSS assets. It will search for CSS assets during the
// Webpack build and will optimize or minimize the CSS (by default it uses cssnano but a
// custom CSS processor can be specified). Can also solve the CSS duplication problem caused
// by "extract-text-webpack-plugin".
const OptimizeCSSAssetsPlugin = require('optimize-css-assets-webpack-plugin');
// A fault-tolerant CSS parser for PostCSS, which will find & fix syntax errors, capable of
// parsing any input.
const safePostCssParser = require('postcss-safe-parser');
// Will generate a manifest file for all resources.
const ManifestPlugin = require('webpack-manifest-plugin');
// Works with html-webpack-plugin to interpolate custom variables into the html file, and just
// think that it is a template resolve engine.
const InterpolateHtmlPlugin = require('react-dev-utils/InterpolateHtmlPlugin');
// A PWA tools set plugin for generating service worker features. But for our enterprise level
// storage GUI app which is required to be real-time response to underlying storage cluster state
// is not only un-useful but also will be confusing especially the network is abnormal or the
// cluster is dead. Also there's no plan to deploy HTTPS for GUI app to support service worker.
...
// index.module.css. CSS module is a alternative plan of scope. For MyFolder/MyComponent.module.css and
// class MyClass the output will be MyComponent.module_MyClass__[hash] For MyFolder/index.module.css and
...
module.exports = function(webpackEnv) {
    ...
    // A common function to get style loaders.
    ...
    return {
        ...
        optimization: {
            ...
            minimizer: [
                ...
                new OptimizeCSSAssetsPlugin({
                    // The options passed to the cssProcessor which defaults to cssnano.
                    cssProcessorOptions: {
        ...
        plugins: [
            ...
            // inline the codes of main.xxx.js file into the <script> tag in index.html.
            /*
            ...
            */
            ...
            // to their corresponding output files so that tools can pick it up without
