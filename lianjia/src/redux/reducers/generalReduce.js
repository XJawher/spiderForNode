...
let generalAction = (state = State.main, action) => {
    let {xian, community, weekIncrease, shanghai, shenzhen} = action;
    switch (action.type) {

        case generalActionTypes.SET_XIAN_DATA:
            return Object.assign({}, state, {xian});

        case generalActionTypes.SET_SHANGHAI_DATA:
            return Object.assign({}, state, {shanghai});

        case generalActionTypes.SET_SHENZHEN_DATA:
            return Object.assign({}, state, {shenzhen});
